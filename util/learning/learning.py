...
path_dir1 = 'C:/Users/dohoo/Desktop/mask-detector/data/image/cut_result_no/'
path_dir2 = 'C:/Users/dohoo/Desktop/mask-detector/data/image/cut_result/'
...
#%% 이미지 전처리
num = 0
all_img = np.float32(np.zeros((file_num, 300, 300, 3))) 
